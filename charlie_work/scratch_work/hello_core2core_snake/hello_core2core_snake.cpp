...
int main(int argc, char** argv) {
    ...
    KernelHandle lead_kernel = CreateKernel(
        program,
        "tt_metal/programming_examples/hello_core2core_snake/kernels/lead_kernel.cpp",
        core_array[0],
    ...
    for (int i = 1; i < core_array.size(); i++) {
        ...
        KernelHandle reader_kernel = CreateKernel(
            program,
            "tt_metal/programming_examples/hello_core2core_snake/kernels/reader_kernel.cpp",
            core_array[i],
